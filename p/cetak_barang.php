...
class PDF extends FPDF
{
	...
	function data_barang(){
		...
		mysql_select_db("imk");
		$data=mysql_query("SELECT barang.id_barang,barang.nama_barang,kategori.nama_kategori,barang.stok,barang.harga_beli,barang.id_lokasi,barang.date_added FROM barang INNER JOIN kategori on barang.id_kategori=kategori.id_kategori ORDER BY barang.id_barang DESC");
