	...
	<div class="padding">
		<div class="bgwhite">
			<div class="padding">
				...
				<?php } ?>
				<?php
				$getqheader=$root->con->query("select transaksi.id_transaksi,transaksi.tgl_transaksi,transaksi.no_invoice,transaksi.total_bayar,transaksi.kode_kasir,user.nama from transaksi inner join user on transaksi.id=user.id  where id_transaksi='$_GET[id_transaksi]'");
				$get=$getqheader->fetch_assoc();
				$getqheader=$root->con->query("select transaksi.id_transaksi,transaksi.tgl_transaksi,transaksi.no_invoice,transaksi.total_bayar,transaksi.id,user.username from transaksi inner join user on transaksi.kode_kasir=user.id  where id_transaksi='$_GET[id_transaksi]'");
